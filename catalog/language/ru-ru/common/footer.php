...
$_['text_anketa_text']      = 'Процентная ставка по ипотечным кредитам по программе «Новоселье» от – 6 % годовых.
Воспользуйтесь Онлайн анкетой для получения решения по ипотеке не выходя из дома.';
$_['text_anketa_link']      = 'Ссылка на Онлайн анкету';
