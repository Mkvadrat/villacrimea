			...
			foreach ($articles as $article_id) {
				...
				if ($article_info) {
					if ($article_info['image']) {
						$image = $this->model_tool_image->resize($article_info['image'], $setting['width'], $setting['height'], 'product_related');
					} else {
					...
					if (!empty($agent_info['image'])) {
						$image_agent = $this->model_tool_image->resize($agent_info['image'], $setting['width'], $setting['height']);
					} else {
