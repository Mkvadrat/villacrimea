<?php
$_['heading_title']               = 'Фильтр объектов OCFilter';
...
// Text
$_['text_edit']      					    = 'Настройки фильтра объектов OCFilter';
$_['text_select']      					  = '-- Выберите --';
$_['text_selected']      					= 'Выбрано';
$_['text_success']                = 'Вы успешно обновили настройки модуля &laquo;Фильтр объектов OCFilter&raquo;!';
...
$_['entry_show_counter']          = 'Показывать счетчик объектов';
...
$_['entry_consider_option']       = 'Учитывать цену опций объекта';
...
$_['entry_copy_option']           = 'Копировать опции объектов';
...
$_['help_sub_category']          = 'Позволяет выводить фильтры и объекты в родительских категориях.<br /><strong>Внимание!</strong> Включение этого режима может замедлить работу каталога.<br />Рекомендуем использовать фильтры только в последних дочерних категориях.';
$_['help_copy_status_auto']      = 'В автоматическом режиме статус для новых фильтров будет назначаться в зависимости от их количества и связей.<br />Отключены будут те фильтры, у которых более 100 значений, у которых нет значений или они не привязаны к объектам либо категориям.';
$_['help_search_button']         = 'Позволяет сначала выбрать необходимые фильтры, затем произвести поиск объектов.';
...
$_['help_show_diagram']          = 'Графически показывает количество объектов текущего значения ценового диапазона.';
$_['help_show_counter']          = 'Отображает количество объектов для каждого значения.<br />На скорость загрузки страницы этот параметр не влияет.';
$_['help_show_selected']         = 'Отображает блок выбранных параметров с возможностью исключения их из запроса.';
$_['help_consider_discount']     = 'Позволяет фильтровать объекты не только по статической цене, но и по скидкам.';
...
$_['help_show_options_limit']    = 'Укажите лимит количества фильтров, которые будут выводиться в модуле фильтра объектов. Чтобы выводить все фильтры, укажите 0.';
$_['help_show_values_limit']     = 'Укажите лимит количества значений, которые будут выводиться в модуле фильтра объектов для каждой опции. Чтобы выводить все значения, укажите 0.';
...
$_['help_manufacturer']          = 'Позволяет фильтровать объекты по производителям текущей категории.';
$_['help_stock_status']          = 'Даёт возможность фильтровать объекты по наличию на складе.';
