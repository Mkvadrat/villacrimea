...
$_['text_product']                     = 'обьекты и категории';
...
$_['entry_image_product']              = 'Обьекта (Ш x В)';
...
$_['help_product_limit'] 	           = 'Сколько элементов показывать на одной странице (обьекты, категории, и т.п.)';
$_['help_product_description_length']  = 'Сколько знаков показывать из описания обьекта в режиме список.';

// Error
$_['error_permission']                 = 'У вас не достаточно прав!';
$_['error_limit']                      = 'Укажите количество обьектов на странице!';
$_['error_product_description_length'] = 'Укажите количество символов в кратком описании обьекта для режима список!';
$_['error_image_thumb']                = 'Укажите размер миниатюр!';
$_['error_image_popup']                = 'Укажите размер всплывающих изображений обьекта!';
$_['error_image_product']              = 'Укажите размер изображения для обьектов!';
$_['error_image_category']             = 'Укажите размер изображения для категорий!';
$_['error_image_additional']           = 'Укажите размер дополнительных изображений обьекта!';
$_['error_image_related']              = 'Укажите размер изображений для рекомендуемых (похожих) обьектов!';
$_['error_image_compare']              = 'Укажите размер изображений обьекта для списка сравнений!';
$_['error_image_wishlist']             = 'Укажите размер изображений обьекта для закладок!';
$_['error_image_cart']                 = 'Укажите размер изображений обьекта для корзины!';
