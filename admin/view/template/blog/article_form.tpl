              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  ...
                  <div id="article-download" class="well well-sm" style="height: 150px; overflow: auto;">
                    <?php foreach ($article_downloads as $article_download) { ?>
                    <div id="article-download<?php echo $article_download['download_id']; ?>"><i class="fa fa-minus-circle"></i> <?php echo $article_download['name']; ?>
                      <input type="hidden" name="article_download[]" value="<?php echo $article_download['download_id']; ?>" />
                    </div>
                    <?php } ?>
                  </div>
                </div>
