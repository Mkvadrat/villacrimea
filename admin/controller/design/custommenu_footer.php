...
class ControllerDesignCustomMenuFooter extends Controller {

    private $error = array();

    public function index() {
        $this->load->language('design/custommenu_footer');
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('design/custommenu_footer', 'token=' . $this->session->data['token'], 'SSL'));
		}
		...
		$data['changecustommenuPosition'] = $this->url->link('design/custommenu_footer/changecustommenuPosition', 'token=' . $this->session->data['token'], 'SSL');

		$data['deletecustommenu'] = $this->url->link('design/custommenu_footer/deletecustommenu', 'token=' . $this->session->data['token'], 'SSL');
		$data['deleteChildcustommenu'] = $this->url->link('design/custommenu_footer/deleteChildcustommenu', 'token=' . $this->session->data['token'], 'SSL');

		$data['enablecustommenu'] = $this->url->link('design/custommenu_footer/enablecustommenu', 'token=' . $this->session->data['token'], 'SSL');
		$data['enableChildcustommenu'] = $this->url->link('design/custommenu_footer/enableChildcustommenu', 'token=' . $this->session->data['token'], 'SSL');

		$data['disablecustommenu'] = $this->url->link('design/custommenu_footer/disablecustommenu', 'token=' . $this->session->data['token'], 'SSL');
		$data['disableChildcustommenu'] = $this->url->link('design/custommenu_footer/disableChildcustommenu', 'token=' . $this->session->data['token'], 'SSL');

		$data['refresch'] = $this->url->link('design/custommenu_footer', 'token=' . $this->session->data['token'], 'SSL');
		$data['add'] = $this->url->link('design/custommenu_footer/add', 'token=' . $this->session->data['token'], 'SSL');
		$data['save'] = $this->url->link('design/custommenu_footer/save', 'token=' . $this->session->data['token'], 'SSL');
        ...
        foreach($custommenus as $id => $custommenu) {
            $rent_custommenu[] = array(
                ...
                'store'         => $this->model_design_custommenu_footer->getcustommenuStores($custommenu['custommenu_id']),
                'isSubcustommenu'     => ''
            );
            ...
            foreach($custommenu_child as $child_id => $child_custommenu) {
                ...
                $rent_custommenu[] = array(
                    ...
                    'store'         => $this->model_design_custommenu_footer->getChildcustommenuStores($child_custommenu['custommenu_child_id']),
                    'isSubcustommenu'     => $custommenu['custommenu_id']
                );
            }
        }

		$data['custommenu_desc'] = $this->model_design_custommenu_footer->getcustommenuDesc();
		$data['custommenu_child_desc'] = $this->model_design_custommenu_footer->getcustommenuChildDesc();
		...
		$data['action'] = $this->url->link('design/custommenu_footer', 'token=' . $this->session->data['token'], 'SSL');
		...
		$this->response->setOutput($this->load->view('design/custommenu_footer.tpl', $data));
	}

	protected function validateForm() {
		if (!$this->user->hasPermission('modify', 'design/custommenu_footer')) {
    ...
    public function add() {
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
            ...
            $custommenu = $this->model_design_custommenu_footer->add($this->request->post, $languages);
    ...
    protected function addHtml($custommenu, $languages){
        ...
        $custommenu_desc = $this->model_design_custommenu_footer->getcustommenuDesc();
    ...
    public function save() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
            if($this->request->get['type'] == 'child') {
                $this->model_design_custommenu_footer->saveChild($this->request->post);
            } else {
                $this->model_design_custommenu_footer->save($this->request->post);
            }
    ...
    public function deletecustommenu() {
        ...
        if (isset($this->request->post['custommenu_id']) && $this->validateDelete()) {
            $this->model_design_custommenu_footer->deletecustommenu($this->request->post['custommenu_id']);
    ...
    public function deleteChildcustommenu() {
        ...
        if (isset($this->request->post['custommenu_id']) && $this->validateDelete()) {
            $this->model_design_custommenu_footer->deleteChildcustommenu($this->request->post['custommenu_id']);
	...
	public function enablecustommenu() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
            $this->model_design_custommenu_footer->enablecustommenu($this->request->post['custommenu_id']);
			$this->session->data['success'] = $this->language->get('text_success');
	...
	public function disablecustommenu() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
            $this->model_design_custommenu_footer->disablecustommenu($this->request->post['custommenu_id']);
			$this->session->data['success'] = $this->language->get('text_success');
	...
	public function enableChildcustommenu() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
            $this->model_design_custommenu_footer->enableChildcustommenu($this->request->post['custommenu_id']);
			$this->session->data['success'] = $this->language->get('text_success');
		}
	...
	public function disableChildcustommenu() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
            $this->model_design_custommenu_footer->disableChildcustommenu($this->request->post['custommenu_id']);
			$this->session->data['success'] = $this->language->get('text_success');
		}
	...
	public function changecustommenuPosition() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
            $this->model_design_custommenu_footer->changecustommenuPosition($this->request->post);
			$this->session->data['success'] = $this->language->get('text_success');
